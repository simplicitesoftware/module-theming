...
`AbePortefeuille` business object definition
--------------------------------------------
...
| Name                                                         | Type                                     | Required | Updatable | Personal | Description                                                                      |
|--------------------------------------------------------------|------------------------------------------|----------|-----------|----------|----------------------------------------------------------------------------------|
| `abePftPortfolioId`                                          | int(5)                                   | yes*     | yes       |          | -                                                                                |
| `abePftName`                                                 | text(100)                                | yes      | yes       |          | -                                                                                |
| `abePftCreatedDate`                                          | date                                     | yes      | yes       |          | -                                                                                |
...
`AbeChild` business object definition
-------------------------------------

Represents a child who owns a portfolio

### Fields

| Name                                                         | Type                                     | Required | Updatable | Personal | Description                                                                      |
|--------------------------------------------------------------|------------------------------------------|----------|-----------|----------|----------------------------------------------------------------------------------|
| `abeChiPftId` link to **`AbePortefeuille`**                  | id                                       |          | yes       |          | -                                                                                |
| _Ref. `abeChiPftId.abePftPortfolioId`_                       | _int(5)_                                 |          |           |          | -                                                                                |
| `abeChiLdId`                                                 | int(5)                                   | yes*     | yes       |          | -                                                                                |
| `abeChiName`                                                 | text(100)                                | yes      | yes       |          | -                                                                                |

`AbePftChi` business object definition
--------------------------------------

NN between Portfolio and Child

### Fields

| Name                                                         | Type                                     | Required | Updatable | Personal | Description                                                                      |
|--------------------------------------------------------------|------------------------------------------|----------|-----------|----------|----------------------------------------------------------------------------------|
| `abePftchiPftId` link to **`AbePortefeuille`**               | id                                       | yes*     | yes       |          | -                                                                                |
| _Ref. `abePftchiPftId.abePftPortfolioId`_                    | _int(5)_                                 |          |           |          | -                                                                                |
| `abePftchiChiId` link to **`AbeChild`**                      | id                                       | yes*     | yes       |          | -                                                                                |
| _Ref. `abePftchiChiId.abeChiLdId`_                           | _int(5)_                                 |          |           |          | -                                                                                |

`AbeObjectFinancier` business object definition
-----------------------------------------------
...
| Name                                                         | Type                                     | Required | Updatable | Personal | Description                                                                      |
|--------------------------------------------------------------|------------------------------------------|----------|-----------|----------|----------------------------------------------------------------------------------|
| `abeOftPftId` link to **`AbePortefeuille`**                  | id                                       |          | yes       |          | -                                                                                |
| _Ref. `abeOftPftId.abePftPortfolioId`_                       | _int(5)_                                 |          |           |          | -                                                                                |
| `abeOftFinancialObjectId`                                    | int(5)                                   | yes*     | yes       |          | -                                                                                |
| `abeOftName`                                                 | text(100)                                | yes      | yes       |          | -                                                                                |
| `abeOftValue`                                                | float(5, 2)                              | yes      | yes       |          | -                                                                                |

`AbeBankAccount` business object definition
-------------------------------------------
...
| Name                                                         | Type                                     | Required | Updatable | Personal | Description                                                                      |
|--------------------------------------------------------------|------------------------------------------|----------|-----------|----------|----------------------------------------------------------------------------------|
| `abeBacChiId` link to **`AbeChild`**                         | id                                       |          | yes       |          | -                                                                                |
| _Ref. `abeBacChiId.abeChiLdId`_                              | _int(5)_                                 |          |           |          | -                                                                                |
| `abeBacPftId` link to **`AbePortefeuille`**                  | id                                       |          | yes       |          | -                                                                                |
| _Ref. `abeBacPftId.abePftPortfolioId`_                       | _int(5)_                                 |          |           |          | -                                                                                |
| `abeBacBankAccountId`                                        | int(5)                                   | yes*     | yes       |          | -                                                                                |
| `abeBacName`                                                 | text(100)                                | yes      | yes       |          | -                                                                                |
| `abeBacBalance`                                              | float(5, 2)                              | yes      | yes       |          | -                                                                                |
...
`AbeHomeContact` external object definition
-------------------------------------------
...
`ImmHomeContact` external object definition
-------------------------------------------
...
`Swi1HomeContact` external object definition
--------------------------------------------




`Swi2HomeContact` external object definition
--------------------------------------------




`SwiHomeContact` external object definition
-------------------------------------------
...
`tes1HomeContact` external object definition
--------------------------------------------




`tesHomeContact` external object definition
-------------------------------------------
...
`yoHomeContact` external object definition
------------------------------------------




`yooHomeContact` external object definition
-------------------------------------------
