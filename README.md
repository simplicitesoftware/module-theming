...
`AbelEisenhowerCategory` business object definition
---------------------------------------------------
...
| Name                                                         | Type                                     | Required | Updatable | Personal | Description                                                                      |
|--------------------------------------------------------------|------------------------------------------|----------|-----------|----------|----------------------------------------------------------------------------------|
| `abelCtgId`                                                  | char(100)                                | yes*     | yes       |          | -                                                                                |
| `abelCtgTitle`                                               | char(100)                                | yes      | yes       |          | -                                                                                |
| `abelCtgColor`                                               | color                                    | yes      | yes       |          | -                                                                                |
| `abelCtgIsImportant`                                         | boolean                                  | yes      | yes       |          | -                                                                                |
| `abelCtgIsUrgent`                                            | boolean                                  | yes      | yes       |          | -                                                                                |
| `abelCtgTextColor`                                           | color                                    |          | yes       |          | -                                                                                |

`AbelEisenhowerTask` business object definition
-----------------------------------------------
...
| Name                                                         | Type                                     | Required | Updatable | Personal | Description                                                                      |
|--------------------------------------------------------------|------------------------------------------|----------|-----------|----------|----------------------------------------------------------------------------------|
| `abelTskId`                                                  | char(100)                                | yes*     | yes       |          | -                                                                                |
| `abelTskTitle`                                               | char(300)                                | yes      | yes       |          | -                                                                                |
| `abelTskDescription`                                         | text(1500)                               |          | yes       |          | -                                                                                |
| `abelTskStatus`                                              | enum(100) using `ABEL_TSK_STATUS` list   | yes      | yes       |          | -                                                                                |
| `abelTskDeadline`                                            | date                                     |          | yes       |          | -                                                                                |
| `abelTskNote`                                                | text(500)                                |          | yes       |          | -                                                                                |
| `abelTskCtgId` link to **`AbelEisenhowerCategory`**          | id                                       |          | yes       |          | -                                                                                |
| _Ref. `abelTskCtgId.abelCtgId`_                              | _char(100)_                              |          |           |          | -                                                                                |
| _Ref. `abelTskCtgId.abelCtgTitle`_                           | _char(100)_                              |          |           |          | -                                                                                |
...
`AbelEisenhowerMatrix` external object definition
-------------------------------------------------
