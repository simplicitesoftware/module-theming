...
`AbelColorPalette` business object definition
---------------------------------------------
...
|--------------------------------------------------------------|------------------------------------------|----------|-----------|----------|----------------------------------------------------------------------------------|
| `abelAcpLabel`                                               | char(100)                                | yes*     | yes       |          | -                                                                                |
| `abelAcpMainColor`                                           | color                                    | yes*     | yes       |          | -                                                                                |
| `abelAcpColor1`                                              | color                                    | yes      | yes       |          | -                                                                                |
| `abelAcpColor2`                                              | color                                    | yes      | yes       |          | -                                                                                |
| `abelAcpColor3`                                              | color                                    | yes      | yes       |          | -                                                                                |
| `abelAcpColor4`                                              | color                                    | yes      | yes       |          | -                                                                                |
...
| `aiGroupGuiVirtual` link to **`AiGroupGuiDesc`**             | char(10)                                 |          | yes       |          | -                                                                                |
...
`AaaOrderProduct` business object definition
--------------------------------------------

Represents the link between an order and a product

### Fields

| Name                                                         | Type                                     | Required | Updatable | Personal | Description                                                                      |
|--------------------------------------------------------------|------------------------------------------|----------|-----------|----------|----------------------------------------------------------------------------------|
| `aaaOpProId` link to **`AaaProduct`**                        | id                                       |          | yes       |          | -                                                                                |
| _Ref. `aaaOpProId.aaaProCode`_                               | _char(100)_                              |          |           |          | -                                                                                |
| _Ref. `aaaOpProId.aaaProOpCode`_                             | _char(100)_                              |          |           |          | -                                                                                |
| _Ref. `aaaOpProId.aaaProDuctID`_                             | _char(100)_                              |          |           |          | -                                                                                |
| `aaaOpCode`                                                  | char(100)                                | yes*     | yes       |          | -                                                                                |
| `aaaOpOrdCode`                                               | char(100)                                | yes*     | yes       |          | -                                                                                |
| `aaaOpOrdErID`                                               | char(100)                                | yes*     | yes       |          | -                                                                                |
| `aaaOpOrdErID`                                               | char(100)                                | yes*     | yes       |          | -                                                                                |
| `aaaOpProductID`                                             | char(100)                                | yes      | yes       |          | -                                                                                |
| `aaaOpQuantity`                                              | int(5)                                   | yes      | yes       |          | -                                                                                |
...
`AaaProduct` business object definition
---------------------------------------

Represents the products available in the application

### Fields

| Name                                                         | Type                                     | Required | Updatable | Personal | Description                                                                      |
|--------------------------------------------------------------|------------------------------------------|----------|-----------|----------|----------------------------------------------------------------------------------|
| `aaaProCode`                                                 | char(100)                                | yes*     | yes       |          | -                                                                                |
| `aaaProOpId` link to **`AaaOrderProduct`**                   | id                                       |          | yes       |          | -                                                                                |
| _Ref. `aaaProOpId.aaaOpCode`_                                | _char(100)_                              |          |           |          | -                                                                                |
| _Ref. `aaaProOpId.aaaOpOrdCode`_                             | _char(100)_                              |          |           |          | -                                                                                |
| _Ref. `aaaProOpId.aaaOpOrdErID`_                             | _char(100)_                              |          |           |          | -                                                                                |
| `aaaProName`                                                 | char(100)                                | yes      | yes       |          | -                                                                                |
| `aaaProCode`                                                 | char(100)                                | yes*     | yes       |          | -                                                                                |
| `aaaProDescription`                                          | text(100)                                |          | yes       |          | -                                                                                |
| `aaaProOpCode`                                               | char(100)                                | yes*     | yes       |          | -                                                                                |
| `aaaProPrice`                                                | float(5, 2)                              | yes      | yes       |          | -                                                                                |
| `aaaProDuctID`                                               | char(100)                                | yes*     | yes       |          | -                                                                                |
| `aaaProStock_count`                                          | int(5)                                   | yes      | yes       |          | -                                                                                |
| `aaaProName`                                                 | char(100)                                | yes      | yes       |          | -                                                                                |
| `aaaProDuctName`                                             | char(100)                                | yes      | yes       |          | -                                                                                |
| `aaaProDescription`                                          | text(100)                                |          | yes       |          | -                                                                                |
| `aaaProStock_count`                                          | int(5)                                   | yes      | yes       |          | -                                                                                |
| `aaaProStockCount`                                           | int(5)                                   | yes      | yes       |          | -                                                                                |
| `aaaProPrice`                                                | float(5, 2)                              | yes      | yes       |          | -                                                                                |

`AaaOrder` business object definition
-------------------------------------
...
| Name                                                         | Type                                     | Required | Updatable | Personal | Description                                                                      |
|--------------------------------------------------------------|------------------------------------------|----------|-----------|----------|----------------------------------------------------------------------------------|
| `aaaOrdCode`                                                 | char(100)                                | yes*     | yes       |          | -                                                                                |
| `aaaOrdUsrId` link to **`AaaUser`**                          | id                                       |          | yes       |          | -                                                                                |
| _Ref. `aaaOrdUsrId.aaaUsrCode`_                              | _char(100)_                              |          |           |          | -                                                                                |
| `aaaOrdOpId` link to **`AaaOrderProduct`**                   | id                                       |          | yes       |          | -                                                                                |
| _Ref. `aaaOrdOpId.aaaOpCode`_                                | _char(100)_                              |          |           |          | -                                                                                |
| _Ref. `aaaOrdOpId.aaaOpOrdCode`_                             | _char(100)_                              |          |           |          | -                                                                                |
| _Ref. `aaaOrdOpId.aaaOpOrdErID`_                             | _char(100)_                              |          |           |          | -                                                                                |
| `aaaOrdUser_id`                                              | int(5)                                   | yes      | yes       |          | -                                                                                |
| `aaaOrdCode`                                                 | char(100)                                | yes*     | yes       |          | -                                                                                |
| `aaaOrdEr_date`                                              | datetime                                 | yes      | yes       |          | -                                                                                |
| `aaaOrdUsrCode`                                              | char(100)                                | yes*     | yes       |          | -                                                                                |
| `aaaOrdTotal_amount`                                         | float(5, 2)                              | yes      | yes       |          | -                                                                                |
| `aaaOrdUsrUserID`                                            | char(100)                                | yes*     | yes       |          | -                                                                                |
| `aaaOrdStatus`                                               | enum(100) using `AAA_ORD_STATUS` list    | yes      | yes       |          | -                                                                                |
| `aaaOrdErID`                                                 | char(100)                                | yes*     | yes       |          | -                                                                                |
| `aaaOrdUser_id`                                              | int(5)                                   | yes      | yes       |          | -                                                                                |
| `aaaOrdUserID`                                               | char(100)                                | yes      | yes       |          | -                                                                                |
| `aaaOrdEr_date`                                              | datetime                                 | yes      | yes       |          | -                                                                                |
| `aaaOrdErDate`                                               | datetime                                 | yes      | yes       |          | -                                                                                |
| `aaaOrdTotal_amount`                                         | float(5, 2)                              | yes      | yes       |          | -                                                                                |
| `aaaOrdTotalAmount`                                          | float(5, 2)                              | yes      | yes       |          | -                                                                                |
| `aaaOrdStatus`                                               | enum(100) using `AAA_ORD_STATUS` list    | yes      | yes       |          | -                                                                                |
...
`AaaUser` business object definition
------------------------------------
...
| Name                                                         | Type                                     | Required | Updatable | Personal | Description                                                                      |
|--------------------------------------------------------------|------------------------------------------|----------|-----------|----------|----------------------------------------------------------------------------------|
| `aaaUsrCode`                                                 | char(100)                                | yes*     | yes       |          | -                                                                                |
| `aaaUsrOrdId` link to **`AaaOrder`**                         | id                                       |          | yes       |          | -                                                                                |
| _Ref. `aaaUsrOrdId.aaaOrdCode`_                              | _char(100)_                              |          |           |          | -                                                                                |
| _Ref. `aaaUsrOrdId.aaaOrdUsrCode`_                           | _char(100)_                              |          |           |          | -                                                                                |
| _Ref. `aaaUsrOrdId.aaaOrdUsrUserID`_                         | _char(100)_                              |          |           |          | -                                                                                |
| _Ref. `aaaUsrOrdId.aaaOrdErID`_                              | _char(100)_                              |          |           |          | -                                                                                |
| `aaaUsrUsername`                                             | char(100)                                | yes      | yes       |          | -                                                                                |
| `aaaUsrCode`                                                 | char(100)                                | yes*     | yes       |          | -                                                                                |
| `aaaUsrEmail`                                                | email(100)                               | yes      | yes       |          | -                                                                                |
| `aaaUsrUserID`                                               | char(100)                                | yes*     | yes       |          | -                                                                                |
| `aaaUsrPassword`                                             | password(100)                            | yes      | yes       |          | -                                                                                |
| `aaaUsrUsername`                                             | char(100)                                | yes      | yes       |          | -                                                                                |
| `aaaUsrAddress`                                              | text(100)                                |          | yes       |          | -                                                                                |
| `aaaUsrEmail`                                                | email(100)                               | yes      | yes       |          | -                                                                                |
| `aaaUsrAddress`                                              | text(100)                                |          | yes       |          | -                                                                                |
| `aaaUsrPassword`                                             | password(100)                            | yes      | yes       |          | -                                                                                |

`AaaOrdPro` business object definition
--------------------------------------

NN between Order and Product

### Fields

| Name                                                         | Type                                     | Required | Updatable | Personal | Description                                                                      |
|--------------------------------------------------------------|------------------------------------------|----------|-----------|----------|----------------------------------------------------------------------------------|
| `aaaOrdproOrdId` link to **`AaaOrder`**                      | id                                       | yes*     | yes       |          | -                                                                                |
| _Ref. `aaaOrdproOrdId.aaaOrdCode`_                           | _char(100)_                              |          |           |          | -                                                                                |
| `aaaOrdproProId` link to **`AaaProduct`**                    | id                                       | yes*     | yes       |          | -                                                                                |
| _Ref. `aaaOrdproProId.aaaProCode`_                           | _char(100)_                              |          |           |          | -                                                                                |

`AaaFavoris` business object definition
---------------------------------------

Représente un produit ajouté aux favoris par un utilisateur.
...
`aaaHomeContact` external object definition
-------------------------------------------




`aaaUndoReGenerate` external object definition
----------------------------------------------




`aaaUpdateGenerate` external object definition
----------------------------------------------




`AbelPaletteCreator` external object definition
-----------------------------------------------
...
`AppTestDashboard` external object definition
---------------------------------------------
...
`tesUpdateGenerate` external object definition
----------------------------------------------




`UICarousel` external object definition
---------------------------------------
